                ...
                <div class="main-carousel  animated fadeInUp">
                    <div class="carousel-cell baza">
                        <div class="wrapper-slide">
                            <a href="../putzgrund/" class="">
                                <img src="../../assets/img/products/ndertimore/baza/Group 3257.png" width="250px"
                                    class="img-fluid" alt="">
                    ...
                    <div class="carousel-cell baza">
                        <div class="wrapper-slide">
                            <a href="../beton/" class="">
                                <img src="../../assets/img/products/ndertimore/baza/Rectangle 82.png" width="250px"
                                    class="img-fluid" alt="">
                    ...
                    <div class="carousel-cell baza">
                        <div class="wrapper-slide">
                            <a href="../grundstandard/" class="">
                                <img src="../../assets/img/products/ndertimore/baza/Rectangle 83.png" width="250px"
                                    class="img-fluid" alt="">
                    ...
                    <div class="carousel-cell baza">
                        <div class="wrapper-slide">
                            <a href="../tiefgrund/" class="">

                                <img src="../../assets/img/products/ndertimore/baza/Rectangle 84.png" width="220px"
                                    class="img-fluid" alt="">
                    ...
                    <div class="carousel-cell baza">
                        <div class="wrapper-slide">
                            <a href="../microgrund/" class="">

                                <img src="../../assets/img/products/ndertimore/baza/Rectangle 85.png" width="220px"
                                    class="img-fluid" alt="">
